...
if __name__ == '__main__':
    ...
    FOLDER_REPORT = os.path.join(BASE_DIR, "results")
    LIST_HITS     = os.path.join(BASE_DIR, "reads_food_microbiomes_k2_B.tsv")
    OUTPUT_TSV    = os.path.join(BASE_DIR, "kraken_absolute_isyeast_subphylum.tsv")
